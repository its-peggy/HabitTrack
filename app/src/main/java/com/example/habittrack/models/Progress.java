...
public class Progress extends ParseObject {
    ...
    public int getQtyCompleted() {
        return getInt(KEY_QTY_COMPLETED);
    }

    public void setQtyCompleted(int qtyCompleted) {
        put(KEY_QTY_COMPLETED, qtyCompleted);
    }
    ...
    public double getPctCompleted() {
        return getDouble(KEY_PCT_COMPLETED);
    }

    public void setPctCompleted(double pctCompleted) {
        put(KEY_PCT_COMPLETED, pctCompleted);
    }
